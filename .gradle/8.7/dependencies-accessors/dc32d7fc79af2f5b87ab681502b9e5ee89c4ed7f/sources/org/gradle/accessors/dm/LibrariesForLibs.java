...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>sprlibsdui</b> with <b>com.spr.sprLibApplication:sprLibSDUI</b> coordinates and
     * with version reference <b>sprlibsdui</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getSprlibsdui() {
        return create("sprlibsdui");
    }
    ...
    public static class AndroidxMaterial3AdaptiveNavigationLibraryAccessors extends SubDependencyFactory {
        private final AndroidxMaterial3AdaptiveNavigationSuiteLibraryAccessors laccForAndroidxMaterial3AdaptiveNavigationSuiteLibraryAccessors = new AndroidxMaterial3AdaptiveNavigationSuiteLibraryAccessors(owner);

        public AndroidxMaterial3AdaptiveNavigationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.material3.adaptive.navigation.suite</b>
         */
        public AndroidxMaterial3AdaptiveNavigationSuiteLibraryAccessors getSuite() {
            return laccForAndroidxMaterial3AdaptiveNavigationSuiteLibraryAccessors;
        }

    }

    public static class AndroidxMaterial3AdaptiveNavigationSuiteLibraryAccessors extends SubDependencyFactory {

        public AndroidxMaterial3AdaptiveNavigationSuiteLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>androidx.compose.material3:material3-adaptive-navigation-suite-android</b> coordinates and
         * with version reference <b>material3AdaptiveNavigationSuiteAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("androidx.material3.adaptive.navigation.suite.android");
        }
    ...
    public static class AndroidxTestEspressoLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>core</b> with <b>androidx.test.espresso:espresso-core</b> coordinates and
         * with version reference <b>androidxTestEspressoCoreVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
    ...
    public static class AndroidxTestExtLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>junit</b> with <b>androidx.test.ext:junit</b> coordinates and
         * with version reference <b>androidxTestExtJunitVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJunit() {
    ...
    public static class CoilLibraryAccessors extends SubDependencyFactory {
        ...
        private final CoilSvgLibraryAccessors laccForCoilSvgLibraryAccessors = new CoilSvgLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>coil.svg</b>
         */
        public CoilSvgLibraryAccessors getSvg() {
            return laccForCoilSvgLibraryAccessors;
        }
    ...
    public static class CoilComposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v260</b> with <b>io.coil-kt:coil-compose</b> coordinates and
         * with version reference <b>coilCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV260() {
            return create("coil.compose.v260");
        }

    }

    public static class CoilSvgLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public CoilSvgLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>v260</b> with <b>io.coil-kt:coil-svg</b> coordinates and
         * with version reference <b>coilSvg</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV260() {
            return create("coil.svg.v260");
        }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>video</b> with <b>io.sanghun:compose-video</b> coordinates and
         * with version reference <b>composeVideo</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getVideo() {
            return create("compose.video");
        }
    ...
    public static class ConverterMoshiLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>v240</b> with <b>com.squareup.retrofit2:converter-moshi</b> coordinates and
         * with version reference <b>converterMoshi</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV240() {
            return create("converter.moshi.v240");
        }
    ...
    public static class JetbrainsKotlinxCoroutinesLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>jetbrainsKotlinx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
    ...
    public static class SquareupConverterLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getMoshi() {
            return create("squareup.converter.moshi");
        }

    }

    public static class SquareupMoshiLibraryAccessors extends SubDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>adaptiveNavigationSuite</b> with value <b>1.0.0-alpha07</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxTestEspressoCoreVersion</b> with value <b>3.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxTestEspressoCoreVersion() { return getVersion("androidxTestEspressoCoreVersion"); }

        /**
         * Version alias <b>androidxTestExtJunitVersion</b> with value <b>1.1.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxTestExtJunitVersion() { return getVersion("androidxTestExtJunitVersion"); }
        ...
        /**
         * Version alias <b>coilSvg</b> with value <b>2.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCoilSvg() { return getVersion("coilSvg"); }
        ...
        /**
         * Version alias <b>composeVideo</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComposeVideo() { return getVersion("composeVideo"); }
        ...
        /**
         * Version alias <b>daggerCompiler</b> with value <b>2.47</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>foundationAndroid</b> with value <b>1.7.0-beta04</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>jetbrainsKotlinx</b> with value <b>1.7.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>material3AdaptiveNavigationSuiteAndroid</b> with value <b>1.3.0-beta04</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaterial3AdaptiveNavigationSuiteAndroid() { return getVersion("material3AdaptiveNavigationSuiteAndroid"); }
        ...
        /**
         * Version alias <b>media3Exoplayer</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mockitoCore</b> with value <b>2.25.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mockitoKotlin</b> with value <b>2.25.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>sprlibsdui</b> with value <b>0.0.6-test03</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSprlibsdui() { return getVersion("sprlibsdui"); }
    ...
    public static class Material3VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>material3.adaptive</b> with value <b>1.0.0-beta01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
